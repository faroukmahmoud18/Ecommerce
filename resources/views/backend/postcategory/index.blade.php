...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">{{__('post_category.page_title_index')}}</h6>
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="{{__('post_category.add_new_button_tooltip')}}"><i class="fas fa-plus"></i> {{__('post_category.add_new_button')}}</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            @foreach($postCategories as $data)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('post-category.edit',$data->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="{{__('admin_common.edit_button_tooltip')}}" data-placement="bottom"><i class="fas fa-edit"></i></a>
        ...
        @else
          <h6 class="text-center">{{__('post_category.no_post_categories_found')}}</h6>
        @endif
      </div>
    </div>
</div>
